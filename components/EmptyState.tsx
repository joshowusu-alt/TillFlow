...
type EmptyStateProps = {
  icon?: 'chart' | 'box' | 'receipt' | 'alert' | 'check';
  title: string;
  subtitle?: string;
...
export default function EmptyState({ icon = 'chart', title, subtitle, cta }: EmptyStateProps) {
  return (
    <div className="flex flex-col items-center py-10 text-center">
      ...
      {cta && (
        <Link href={cta.href} className="btn-primary mt-4 text-sm">
          {cta.label}
        </Link>
      )}
    </div>
