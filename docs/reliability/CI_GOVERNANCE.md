...
1. `CI / pos-safety` — focused checkout/shift/drawer/payment/return unit tests plus smoke/deep/phase-3A E2E, plus read-only UI shell geometry (`test:e2e:ui-programme`, retries 0, seed owner, no sales)
