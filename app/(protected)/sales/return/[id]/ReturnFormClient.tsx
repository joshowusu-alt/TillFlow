...
export default function ReturnFormClient({
  ...
  // Inline confirmation — no modal overlay, works on all screen sizes
  if (showConfirm) {
    return (
      <div className="space-y-4">
        ...
        <div className="flex gap-3">
          <button
            type="button"
            className="flex-1 rounded-xl border border-black/15 bg-white px-4 py-3 text-sm font-semibold hover:bg-black/5"
