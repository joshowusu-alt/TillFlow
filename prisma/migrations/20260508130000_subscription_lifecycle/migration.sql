...
ALTER TABLE "Business" ADD COLUMN "firstPaymentAt" TIMESTAMP(3);
ALTER TABLE "Business" ADD COLUMN "currentPeriodStartedAt" TIMESTAMP(3);
ALTER TABLE "Business" ADD COLUMN "currentPeriodEndsAt" TIMESTAMP(3);
ALTER TABLE "Business" ADD COLUMN "nextBillingDate" TIMESTAMP(3);
ALTER TABLE "Business" ADD COLUMN "paymentGraceEndsAt" TIMESTAMP(3);
ALTER TABLE "Business" ADD COLUMN "suspendedAt" TIMESTAMP(3);
ALTER TABLE "Business" ADD COLUMN "cancelledAt" TIMESTAMP(3);
