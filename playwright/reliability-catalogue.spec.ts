 ...
 *
 * CSV import (REL-IMP-P104-01) and persisted opening stock only.
 * New-business onboarding button lives in reliability-onboarding-manual.
 */
...
test.describe('Reliability catalogue', () => {
  ...
  test('Preview catalogue, CSV import, and persisted opening stock', async ({ page }) => {
    ...
    await test.step('prove sellable + CSV import products persist once', async () => {
